...
public class MendixGetDataExpressionResolver implements IMxConditionExpressionResolver
{
    ...
    public static final Pattern EXPRESSIONPATTERN = Pattern.compile(String.format("\\$\\(%s\\.%s\\.input\\.([a-zA-Z0-9_]+)\\)", IMxConditionExpressionResolver.EXPRESSIONKEYWORD, RESOLVER_KEY));
    @Override
